...
import com.ptit.shopapp.repositories.ProductImageRepository;
...
public class ProductService implements IProductService {
    ...
    Category existingCategory = categoryRepository
        ...
        .orElseThrow(() ->
            new DataNotFoundException(
                "cannot find category wih id = " + productDTO.getCategoryId()));
  ...
  public Product updateProduct(long id, ProductDTO productDTO) throws Exception {
    ...
    if(existingProduct != null){
      // copy cac thuoc tinh tu dto sang model
      Category existingCategory = categoryRepository
          .findById(productDTO.getCategoryId())
          .orElseThrow(() ->
              new DataNotFoundException(
  ...
  public ProductImage createProductImage(Long productId, ProductImageDTO productImageDTO)
    ...
    Product existingProduct = productRepository
        ...
        .orElseThrow(() ->
            new DataNotFoundException(
                "cannot find category wih id = " + productImageDTO.getProductId()));
    ...
    if(size > ProductImage.MAXIMUM_IMAGES_PER_PRODUCT) {
      throw new InvalidParamException("size must be <= " + ProductImage.MAXIMUM_IMAGES_PER_PRODUCT);
    }
